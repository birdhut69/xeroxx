  ...
  return (
    <div className="bg-white rounded-3xl p-4 sm:p-5 max-w-xl w-full max-h-[92vh] flex flex-col gap-3 shadow-2xl border border-[#bec9c5] animate-in zoom-in-95 duration-150 overflow-y-auto">
      ...
      <div className="flex flex-col sm:flex-row gap-4 bg-[#f8fafc] p-3 rounded-2xl border border-[#bec9c5]/30">
        ...
        <div className="relative bg-[#1e293b] rounded-2xl overflow-hidden shadow-inner flex items-center justify-center min-h-[260px] max-h-[360px] w-full sm:w-1/2">
          <canvas
            ref={baseCanvasRef}
            className="max-w-full max-h-[340px] object-contain rounded-lg shadow-md"
          />
        </div>
          ...
          <div className="space-y-1.5">
            ...
            <div className="grid grid-cols-2 gap-1.5">
              <button
                ...
                className={`py-1.5 px-2 rounded-xl border font-bold text-[10.5px] cursor-pointer transition-all ${
                  stampPreset === 'SELF_ATTEST'
                    ? 'border-[#00a884] bg-emerald-50 text-[#00453d] ring-2 ring-[#00a884]/30'
            ...
            {stampPreset === 'CUSTOM' && (
              <input
                ...
                className="w-full mt-1.5 px-2.5 py-1.5 rounded-lg border border-[#bec9c5] text-xs font-semibold"
              />
            )}
          </div>
          ...
          <div className="space-y-1">
            ...
            <div className="bg-white rounded-xl border-2 border-dashed border-[#00a884]/50 overflow-hidden shadow-inner touch-none relative">
              <canvas
                ...
                className="w-full h-[75px] cursor-crosshair"
              />
              {!hasSignature && (
                <div className="absolute inset-0 flex items-center justify-center text-[10.5px] text-[#9ca3af] pointer-events-none">
            ...
            <div className="space-y-1">
              ...
              <div className="grid grid-cols-3 gap-1 text-[10px]">
                <button
                  ...
                  className="py-1 rounded bg-white border border-[#bec9c5] hover:bg-gray-50 font-semibold"
                >
                  Bottom-L
                </button>
                <button
            ...
            <div className="space-y-1">
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className={`w-6 h-6 rounded-full bg-[#1E3A8A] cursor-pointer ${
                    inkColor === '#1E3A8A' ? 'ring-2 ring-offset-1 ring-[#1E3A8A]' : ''
                  }`}
                  title="Classic Blue"
                />
                <button
                  ...
                  className={`w-6 h-6 rounded-full bg-[#000000] cursor-pointer ${
                    inkColor === '#000000' ? 'ring-2 ring-offset-1 ring-black' : ''
                  }`}
                  title="Formal Black"
                />
                <button
                  ...
                  className={`w-6 h-6 rounded-full bg-[#6B21A8] cursor-pointer ${
                    inkColor === '#6B21A8' ? 'ring-2 ring-offset-1 ring-purple-600' : ''
                  }`}
                  title="Stamp Purple"
                />
              </div>
